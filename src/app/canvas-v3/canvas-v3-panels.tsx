...
export function CoachSidebar(props: SidebarProps) {
  ...
  return (
    <aside className={styles.coachSidebar} data-open={props.open} data-stage={currentStage}>
        ...
        <div className={styles.sidebarContent}>
          ...
          {props.node && (
            <section className={styles.sidebarSelection}>
              ...
              {props.node.details && <p className={styles.sidebarDetails}>{props.node.details}</p>}
              <div className={styles.sidebarSelectionActions}>
                ...
                <button type="button" onClick={props.onDuplicateSelected}>{icons.duplicate}<span>Duplicar</span></button>
                <button type="button" onClick={props.onConnectSelected}>{icons.connect}<span>Conectar manualmente</span></button>
                <button type="button" className={styles.sidebarDangerAction} onClick={props.onDeleteSelected}>{icons.trash}<span>Excluir card</span></button>
              </div>
