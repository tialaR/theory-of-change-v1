...
const heroRel = 'src/features/theory-of-change/components/result-view/result-view-hero/result-view-hero.tsx';
const hero = fs.readFileSync(path.join(root, heroRel), 'utf8');
if (!hero.includes('../result-view-export-menu/result-view-export-menu')) fail('ResultView hero does not consume the export-menu owner.');
